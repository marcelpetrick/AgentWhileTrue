...
```bash
pipx install 'git+https://github.com/marcelpetrick/AgentWhileTrue.git@agentwhiletrue-v0.44.1'
agent-while-true --version
agent-while-true doctor
```

This README describes the v0.44.1 release. Use a development checkout for
