...
v0.44.3 release candidate; natural live acceptance remains outstanding.
...
- run v0.44.3 or later in full-auto mode with only intended sessions selected;
...
1. **Critical — put the verified release under observation.** Install the
   published v0.44.3 wheel whose hash matches the release SBOM, run `doctor`,
...
by the v0.44.3 tag workflow; the natural reset remains a separate acceptance
