...
v0.44.1 release candidate; natural live acceptance remains outstanding.
...
- run v0.44.1 or later in full-auto mode with only intended sessions selected;
...
1. **Critical — put the verified release under observation.** Install the
   published v0.44.1 wheel whose hash matches the release SBOM, run `doctor`,
...
by the v0.44.1 tag workflow; the natural reset remains a separate acceptance
